...
export default function BlogPage() {
    ...
    useEffect(() => {
        ...
        const fetchBlog = async () => {
            try {
                const res = await axios.get(`${apibaseurl}/blogs/${slug}`);
        ...
        <div className="w-full text-gray-900">
            ...
            <div className="relative w-full h-[60vh] bg-black text-white flex flex-col justify-center items-start px-8 lg:px-20">
                ...
                <div className="relative z-10 max-w-3xl">
                    ...
                    <div className="flex gap-6 text-sm lg:text-base font-semibold flex-wrap">
                ...
                {blog.sections?.length > 0 &&
                    blog.sections.map((section, idx) => (
                        <div key={section.id} className="mb-20">
                            ...
                            {/* Section Image */}
                            {section.image && (
                                <div className="relative w-full h-[400px] lg:h-[500px] mb-6">
                                    <Image
                                        src={section.image}
                                        alt={section.title}
                                        fill
