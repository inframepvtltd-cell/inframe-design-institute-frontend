...
export default function BookDetailsPopup3({ open, onClose }) {
  ...
  const bookDescription = `"This Study Material consist of 15 Books which helps in improving drawing as well as reasoning and other subjects:
...
Book 6: This book guide you about  Design ability for NID only. Chapter's are different from NIFT Design Ability

Book 7: This book guide you about  Foundation of English Grammar include Noun, Pronoun etc

Book 8: This book guide you about  English vocabulary like synonyms , antonyms etc

Book 9: This book guide you about  verbal reasoning.

Book 10: This book consist Quantitative aptitude part 1



Book 11: This book consist Quantitative aptitude part 2


Book 12: This book consist General Knowledge.

Book 13: This book consist Current Affairs.(This will Couriered you in the month of October because Exam Paper Consist last 6 month current news).

Book 14: This book Consist of Non Verbal reasoning consist of Chapter's like Series, Folding Figure and many more.

Book 15: This book consist General awareness

Book 16: This book consist Abstract resoning

Book 17: This book consist Mechanical resoning 

Book 18: This book Consist of Previous year original paper of NIFT exam.

Book 19: This book Consist of Previous year original paper of NID exam.
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-3 xs:gap-4 sm:gap-4 md:gap-5 lg:gap-6 p-3 xs:p-4 sm:p-5 md:p-6 lg:p-6 pb-2 xs:pb-3 sm:pb-4">
          ...
          <div className="relative w-full md:w-1/2 h-48 xs:h-56 sm:h-60 md:h-64 lg:h-72 xl:h-80">
            <Image
              src="/Popup-books/nid-nift-ceed-pg-front.jpg"
          ...
          <div className="relative w-full md:w-1/2 h-48 xs:h-56 sm:h-60 md:h-64 lg:h-72 xl:h-80">
            <Image
              src="/Popup-books/NID-NIFT-CEED-PG-Backside.jpg"
