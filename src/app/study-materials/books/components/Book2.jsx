...
export default function BookDetailsPopup2({ open, onClose }) {
  ...
  const bookDescription = `This Study Material consist of 12 Books which helps in improving drawing as well as reasoning and other subjects:
...
Book 2: This book guide you about basic starting to end product technical drawing of Orthographic projection: Principle Plane, Angle of Projection, Isomertric projection: Introduction, Principle Plane, Angle of Prjection, Difference between isometric projection , Axanometric View  with practise questions and previous year question.
...
Book 4: his book guide you about  Reasoning like Direction Sense test, blood relation test, Cube and dice and more 13 chapters

Book 5: This book guide you about Architecture around us in india and world . Starting with Architectural Glossary, Building construction and material, history of architecture, famous buildings and their Architect's, and basic Reasoning  related to architecture

Book 6: This book guide you about  mathematics chapter limit continuity , differentiabilty  and more  chapters.

Book 7: This book guide you about  mathematics chapter Straight line, Circle, Parabola  and more  chapters.

Book 8: This book guide you about  mathematics chapter Set, relation, Function, Complex number and more  chapters

Book 9: This book Consist of Non Verbal reasoning consist of Chapter's like Series, Folding Figure and many more.

Book 10: This book Consist of Previous year original paper of NATA exam.



Book 11: This book Consist of Previous year original paper of JEE exam.

Book 12:How to manage all subject and attempt complete paper within time limit of exam.
...
Note: Module 12 will be send through mail after receiving photocopy of your NATA Admit card at IDI Jodhpur.`
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-3 xs:gap-4 sm:gap-4 md:gap-5 lg:gap-6 p-3 xs:p-4 sm:p-5 md:p-6 lg:p-6 pb-2 xs:pb-3 sm:pb-4">
          ...
          <div className="relative w-full md:w-1/2 h-48 xs:h-56 sm:h-60 md:h-64 lg:h-72 xl:h-80">
            <Image
              src="/Popup-books/NATA-JEE-front.jpg"
          ...
          <div className="relative w-full md:w-1/2 h-48 xs:h-56 sm:h-60 md:h-64 lg:h-72 xl:h-80">
            <Image
              src="/Popup-books/NATA-JEE-back.jpg"
          ...
          >
            <div className="space-y-4 xs:space-y-5 sm:space-y-5 md:space-y-6 pb-3 xs:pb-4">
              {bookDescription.split("\n\n").map((paragraph, index, array) => {
                // Handle empty paragraphs (multiple newlines)
                  ...
                  if (bookMatch) {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="text-gray-700 text-sm xs:text-base sm:text-base md:text-lg leading-relaxed">{content}</p>
                      </div>
                    );
                  }
                }
