        ...
        <>
            ...
            <div className="bg-white text-black">
                            ...
                            <div className="w-full  bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between">
                                <div>
                                    ...
                                    <p className="text-3xl font-bold py-3 text-black">
                                        Only ₹{specificCourseData?.materialPrice} /-per year
                                    </p>
                                </div>
                        ...
                        <div className="grid lg:grid-cols-3 gap-8">
                            ...
                            <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-[1.01] hover:shadow-2xl transition-all duration-500">
                                <div className="relative">
                                    <img
                                        className="w-full h-[220px] lg:h-[300px] object-cover object-top"
                                ...
                                <div className="p-5 lg:p-6">
                                    ...
                                    <span className="text-xl lg:text-2xl text-black font-bold block mb-4">
                                        ₹ {specificCourseData?.materialPrice} /-per year
                                    </span>
                ...
                <section className="bg-[#f8f8f8] py-16">
                    <section className="max-w-[1320px] mx-auto px-4">
                        <h2 className="lg:text-4xl text-3xl font-extrabold capitalize text-black mb-10">
                            {specificCourseData?.materialTitle} Study Materials
                        </h2>

                        <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-8 items-stretch">
                            {specificCourseData?.materialBooksDescription?.map((book, index) => (
                                <div
                                    key={index}
                     ...
                     hover:shadow-2xl hover:-translate-y-1"
                                >
                                    ...
                                    <div className="mb-4 flex items-center gap-3">
                                        <span className="bg-gradient-to-r from-blue-600 to-blue-800 text-white text-sm font-semibold px-4 py-1 rounded-full">
                                            Book {index + 1}
                                        </span>
                                    </div>
